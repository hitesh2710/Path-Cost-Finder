...
void load_lines(vector <string>& lines) {
    string line;
    ifstream myfile("C:\\Users\\Ashutosh Singh\\source\\repos\\Path finder\\hitesh\\src\\Resources\\example.txt");
    if (myfile.is_open())
    {
...
void hashes(map<pairstr, int>& result, vector<string>& station_name) {
    ifstream myfile("C:\\Users\\Ashutosh Singh\\source\\repos\\Path finder\\hitesh\\src\\Resources\\stations.txt");
    if (myfile.is_open())
    {
        string full;
...
void graph_function(vector <vector<int>>& graph) {
    string l;
    ifstream myfile("C:\\Users\\Ashutosh Singh\\source\\repos\\Path finder\\hitesh\\src\\Resources\\matrix.txt");
    if (myfile.is_open())
    {
        int i = 0;
